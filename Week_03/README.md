...
```Java
Array 1: 1x2, 2x2, <font color=red>3x2</font>, 4x2, <font color=red>5x2</font> ……
Array 2: 1x3, <font color=red>2x3</font>, 3x3, 4x3, <font color=red>5x3</font> ……
Array 3: 1x5, <font color=red>2x5</font>, <font color=red>3x5</font>, 4x5, 5x5 ……
```
- 从上面的数组，我们可以很明显的看到，假设数组长度无限，那么每一个数组其实都全部包含了余下的两个数组
